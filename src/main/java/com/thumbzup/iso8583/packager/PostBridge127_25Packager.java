...
class PostBridge127_25Packager extends SimpleBasePackager {
    ...
    private final static ISOFieldPackager fld127_25[] = new ISOFieldPackager[36 + 1];
    ...
    static {
		...
		fieldMap127_25.put(FieldConstants.FIELD_34, new IFA_LLCHAR(64, "NOT SUPPORTED"));
		fieldMap127_25.put(FieldConstants.FIELD_35, new IFA_LLCHAR(64, "CUSTOMER EXCLUSIVE DATA"));
		fieldMap127_25.put(FieldConstants.FIELD_36, new IFA_LLCHAR(64, "FORM FACTOR INDICATOR"));
