...
public class BASE24Packager extends SimpleBasePackager {
    ...
    static {
        ...
        fieldMap.put(FieldConstants.FIELD_1, new IFA_BITMAP(16, "BIT MAP"));
        ...
        fieldMap.put(FieldConstants.FIELD_35, new IFA_LLCHAR(37, "TRACK 2 DATA"));
        ...
        fieldMap.put(FieldConstants.FIELD_41, new IF_CHAR(16, "CARD ACCEPTOR TERMINAL IDENTIFICACION"));
        fieldMap.put(FieldConstants.FIELD_42, new IFA_NUMERIC(15, "CARD ACCEPTOR IDENTIFICATION CODE"));
        ...
        fieldMap.put(FieldConstants.FIELD_48, new IFA_LLLCHAR(999, "RETAILER DATA"));
        fieldMap.put(FieldConstants.FIELD_49, new IFA_AMOUNT(3, "CURRENCY CODE, TRANSACTION"));
        fieldMap.put(FieldConstants.FIELD_50, new IFA_AMOUNT(3, "CURRENCY CODE, SETTLEMENT"));
        fieldMap.put(FieldConstants.FIELD_51, new IFA_AMOUNT(3, "CURRENCY CODE, CARDHOLDER BILLING"));
        fieldMap.put(FieldConstants.FIELD_52, new IF_CHAR(16, "PIN DATA"));
        fieldMap.put(FieldConstants.FIELD_53, new IFA_NUMERIC(16, "SECURITY RELATED CONTROL INFORMATION"));
        ...
        fieldMap.put(FieldConstants.FIELD_60, new IFA_LLLCHAR(999, "TERMINAL DATA"));
        fieldMap.put(FieldConstants.FIELD_61, new IFA_LLLCHAR(999, "CARD ISSUER DATA"));
        fieldMap.put(FieldConstants.FIELD_62, new IFA_LLLCHAR(999, "CUSTOM TOKENS"));
        fieldMap.put(FieldConstants.FIELD_63, new IFA_LLLCHAR(999, "RESERVED PRIVATE"));
        fieldMap.put(FieldConstants.FIELD_64, new IFA_BINARY(16, "MESSAGE AUTHENTICATION CODE FIELD"));
        fieldMap.put(FieldConstants.FIELD_65, new IFA_BINARY(1, "BITMAP, EXTENDED"));
        ...
        fieldMap.put(FieldConstants.FIELD_93, new IF_CHAR(6, "RESPONSE INDICATOR"));
        ...
        fieldMap.put(FieldConstants.FIELD_96, new IFA_BINARY(16, "MESSAGE SECURITY CODE"));
        ...
        fieldMap.put(FieldConstants.FIELD_121, new IFA_LLLCHAR(23, "BASE24-POS AUTH INDICATORS"));
        fieldMap.put(FieldConstants.FIELD_122, new IFA_LLLNUM(14, "CARD ISSUER IDENTIFICATION CODE"));
        fieldMap.put(FieldConstants.FIELD_123, new IFA_LLLCHAR(153, "CRYPTOGRAFIC SERVICE MESSAGE"));
        fieldMap.put(FieldConstants.FIELD_124, new IFA_LLLCHAR(12, "DEPOSIT TYPE OR BATCH/SHIFT DATA"));
        fieldMap.put(FieldConstants.FIELD_125, new IFA_LLLCHAR(15, "ATM ACCT INDICATOR OR POS SETTLEMENT DATA"));
        fieldMap.put(FieldConstants.FIELD_126, new IFA_LLLCHAR(999, "ATM ADDIC. DATA OR POS PRE-AUTH/CHARGEBACK"));
        fieldMap.put(FieldConstants.FIELD_127, new IFA_LLLCHAR(999, "BASE24-POS User Data"));
        fieldMap.put(FieldConstants.FIELD_128, new IFA_NUMERIC(16, "MAC 2"));
