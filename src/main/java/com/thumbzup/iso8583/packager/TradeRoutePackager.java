...
//        fieldMap.put(FieldConstants.FIELD_151, new IFA_LLLBINARY(999, "3D-Secure Data"));
    ...
    private static class TradeRoute150Packager extends SimpleBasePackager {
        ...
        static {
            ...
            fieldMap150.put(FieldConstants.FIELD_31, new IFA_LLLLCHAR(1677, "Issuer Script Template 1"));
            fieldMap150.put(FieldConstants.FIELD_32, new IFA_LLLLCHAR(1677, "Issuer Script Template 2"));
