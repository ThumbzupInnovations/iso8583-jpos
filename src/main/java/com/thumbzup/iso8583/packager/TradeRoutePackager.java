...
//        fieldMap.put(FieldConstants.FIELD_144, new IFA_LLLCHAR(999, "MAC 2"));
...
//        fieldMap.put(FieldConstants.FIELD_192, new IFA_LLLCHAR(999, "MAC 2"));
    ...
    private static class TradeRoute150Packager extends SimpleBasePackager {
        ...
        static {
            ...
            fieldMap150.put(FieldConstants.FIELD_3, new IFB_LLBINARY(16, "Application Identifier"));
            ...
            fieldMap150.put(FieldConstants.FIELD_11, new IFB_BINARY(18, "Cryptogram"));
            fieldMap150.put(FieldConstants.FIELD_12, new IFB_BINARY(1, "Cryptogram Information Data"));
            fieldMap150.put(FieldConstants.FIELD_13, new IFB_LLLBINARY(252, "CVM List"));
            ...
            fieldMap150.put(FieldConstants.FIELD_17, new IFB_LLBINARY(32, "Issuer Application Data"));
            fieldMap150.put(FieldConstants.FIELD_18, new IFB_LLLLBINARY(507, "Issuer Script Results"));
            ...
            fieldMap150.put(FieldConstants.FIELD_31, new IFB_LLLLBINARY(1677, "Issuer Script Template 1"));
            fieldMap150.put(FieldConstants.FIELD_32, new IFB_LLLLBINARY(1677, "Issuer Script Template 2"));
...
//            fieldMap151.put(FieldConstants.FIELD_7, new IF_CHAR(1, "Terminal Output Capability"));
    ...
    private static class TradeRoute170Packager extends SimpleBasePackager {
        ...
        private final static ISOFieldPackager fld170[] = new ISOFieldPackager[3];
